import java.util.*;
public class QuestionElevenPrimeNumbers{
	public static void main (String[]args){
		QuestionElevenPrimeNumbers answer =new QuestionElevenPrimeNumbers();
		Scanner userInput= new Scanner(System.in);
		System.out.print("Enter An Integer:  ");
		int value = userInput.nextInt();
		System.out.println(value+" is "+(answer.isPrime(value) ? "a" : "not a")+" Prime Number.");
	}
